...
import com.example.movie.domain.repositories.MovieListRepositoryImpl
...
internal class MovieListModule : Module() {
    ...
    init {
        ...
        bind(MovieListRepository::class.java).to(MovieListRepositoryImpl::class.java).singleton()
    }
}