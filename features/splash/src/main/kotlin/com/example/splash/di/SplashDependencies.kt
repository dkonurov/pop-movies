...
internal class SplashDependenciesImpl : SplashDependencies {
    override fun getSplashNavigator(): SplashNavigator = BaseUIScope.getBaseUIScope().getInstance(SplashNavigator::class.java)

    override fun getHttpDataSource(): HttpDataSource = BaseUIScope.getBaseUIScope().getInstance(HttpDataSource::class.java)

    override fun getPrivateDataSource(): PrivateDataSource = BaseUIScope.getBaseUIScope().getInstance(PrivateDataSource::class.java)
    ...
    override fun errorMessageDataSource(): ErrorMessageDataSource = BaseUIScope.getBaseUIScope().getInstance(ErrorMessageDataSource::class.java)
}