...
//import com.example.dmitry.grades.domain.TestAppDelegate
...
//@Config(application = TestAppDelegate::class)
//internal class PrivateDataSourceImplTest {
//
//    val privateDataSourceImpl = PrivateDataSourceImpl(TestAppDelegate.context)
//
//    @Test
//    fun saveBaseUrlNull() {
//        // Arrange
